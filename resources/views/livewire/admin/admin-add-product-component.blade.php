      ...
      <div class="section-body">
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h4>Add Product</h4>
            <a href="{{route('admin.products')}}" class="btn btn-primary">AllProducts</a>
          </div>
          ...
          <div class="card-body">
            <form action="" enctype="multipart/form-data" wire:submit.prevent="addProduct">
              <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                  <label for=""></label>
                  <input type="submit" class="form-control bg-primary" value="Submit" readonly style="color: #fff; font-weight: 600;">
                </div>
