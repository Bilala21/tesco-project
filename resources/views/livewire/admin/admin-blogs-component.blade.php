                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td>{{$blog->created_at}}</td>
                        <td>
                            <img src="{{asset('frontend/assets/images/blogs')}}/{{$blog->image}}" alt="" width="90">
                        </td>
                        <td>
                          <a href="" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                          <a href="" class="btn btn-danger btn-sm" wire:click.prevent="deleteBlog({{$blog->id}})"><i class="fa fa-trash-alt"></i></a>
                        </td>
                      </tr>
                      @endforeach
