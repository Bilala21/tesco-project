                  ...
                  <table class="table table-striped table-hover text-center" id="tableExport" style="width:100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$category->slug}}</td>
                        <td>
                          <a href="{{route('admin.editcategory',['category_slug' => $category->slug])}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" wire:click.prevent="deleteCategory({{$category->id}})"><i class="fa fa-trash-alt"></i></a>
                        </td>
                      </tr>
                      @endforeach
