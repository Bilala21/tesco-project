                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="{{route('product.details',['slug' => $product->slug])}}">
                                            <img src="{{asset('frontend/assets/images/products')}}/{{$product->image}}" alt="{{$product->image}}" class="product-image">
                                        </a>
                    ...
                    <div class="sidebar sidebar-shop">
                        ...
                        <div class="widget widget-banner-sidebar">
                            ...
                            <div class="banner-sidebar banner-overlay">
                                <a href="#">
                                    <img src="{{asset('frontend/assets/images/demos/demo-13/banners/banner-6.jpg')}}" alt="banner">
                                </a>
                            </div><!-- End .banner-ad -->
                        </div><!-- End .widget -->
