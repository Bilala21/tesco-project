        ...
        <div class="card-body">
          <form action="">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" value="Account Address">
            </div>
            <div class="form-group mb-3">
        ...
        <div class="card-body">
          <div class="col-md-3 m-auto pt-4">
            ...
            flex-direction: column; cursor: pointer;">
              <div class="user-icon align-items-center justify-content-center" data-toggle="modal"
              data-target="#exampleModalCenter">
                <i class="fa-solid fa-circle-plus" style="font-size: 40px;"></i>
              </div>
              <span class="mt-2" style="font-size: 23px; color: rgb(27, 27, 209);font-weight: 600;">Add New Address</span>
          </div>
</div>
        </div>
      </div>
              ...
              <div class="form-group">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-light" type="button">Verify</button>
                  </div>
                </div>
              </div>
            </div>
